        	...
        	<form name="frmAdd" method="post" action="{!! route('admin.lienket.postAdd') !!}" enctype="multipart/form-data">
        		<input type="hidden" name="_token" value="{!! csrf_token() !!}" />
          		<div class="col-md-6 col-xs-12">
          			@if($_GET['type']!='marketing' && $_GET['type']!='goidichvu' && $_GET['type']!='step')
					...
					@if($_GET['type']=='goidichvu')
					<div class="form-group">
				      	<label for="desc">Nội dung</label>
				      	<textarea name="txtContent" rows="5" id="txtContent" class="form-control"></textarea>
					</div>
					@endif
					@if($_GET['type']!='goidichvu')
					<div class="form-group">
